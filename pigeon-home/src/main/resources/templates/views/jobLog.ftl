...
<body>
    <div id="log" style="overflow-x: hidden;">
	    ...
	    <el-table class="log-list" :data="logList" :cell-style="setCellStyle" border style="width: 100%;">
            ...
            <el-table-column prop="schedulingType" :formatter="formatterSchedulingType" width="80" label="调度类型"></el-table-column>
        ...
        <div class="pagination" style="text-align: center; margin-top: 10px;">
            <el-pagination @size-change="handleSizeChange" @current-change="handleMemberCurrentChange" :current-page.sync="currentLogIndex"
